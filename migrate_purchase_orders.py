...
# Read the old file
with open('../salon-management-system-2/src/pages/04_BranchManager/PurchaseOrders.jsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Write the new file
with open('src/pages/branch-manager/PurchaseOrders.jsx', 'w', encoding='utf-8') as f:
    f.write(content)

print("PurchaseOrders migration completed!")
