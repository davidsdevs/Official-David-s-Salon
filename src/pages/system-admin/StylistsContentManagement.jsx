...
import BranchStylistsPage from '../public/branch/BranchStylistsPage';
...
const StylistsContentManagement = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Stylists Page Content</h1>
          <p className="text-gray-600">Edit public stylists pages (per location)</p>
        </div>
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-4 bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
              <div className="font-semibold text-gray-900">Stylists Page</div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="relative">
                <BranchStylistsPage
                  key={`${selectedBranchId || 'stylists'}_fullscreen`}
                  embedded={true}
                  cmsEditMode={editMode}
                  cmsBranchId={selectedBranchId || null}
                  cmsBranchName={branchName}
...
export default StylistsContentManagement;
