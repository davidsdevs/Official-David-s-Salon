...
import { Bell, CheckCircle, X, Calendar, Clock, User, Gift, Tag } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-primary-100">
              Stay updated with your appointments, promotions, and rewards
            </p>
          </div>
          {unreadCount > 0 && (
            <button
              onClick={handleMarkAllAsRead}
              className="px-4 py-2 bg-white text-primary-600 rounded-lg hover:bg-primary-50 transition-colors font-medium text-sm"
            >
              Mark all as read
            </button>
          )}
                        ...
                        <div className="flex-1">
                          ...
                          {notification.appointmentDate && (
                            <div className="flex items-center gap-4 text-xs text-gray-500 mt-2">
                              ...
                              {notification.stylistName && (
                                <div className="flex items-center gap-1">
                                  <User className="w-3 h-3" />
                                  <span>{notification.stylistName}</span>
                                </div>
                              )}
                            </div>
                          )}
