...
const StylistServiceHistory = () => {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      } else if (dateFilter === 'monthYear' && selectedMonth && selectedYear) {
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 space-y-4">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative">
            <select
              ...
              onChange={(e) => {
                ...
                } else if (e.target.value === 'monthYear') {
                  setShowDateRange(true);
                } else {
                  setStartDate('');
                  setEndDate('');
            ...
            >
              ...
              <option value="monthYear">Select Month</option>
              <option value="custom">Custom Range</option>
            </select>
            
            {showDateRange && (dateFilter === 'custom' || dateFilter === 'monthYear') && (
              <div className="absolute top-full left-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg p-4 z-50 min-w-[500px]">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold text-gray-900">
                    {dateFilter === 'monthYear' ? 'Select Month & Year' : 'Select Date Range'}
                  </h3>
                  <button
                    onClick={() => {
                      setShowDateRange(false);
                ...
                {(dateFilter === 'custom' && startDate && endDate) || dateFilter === 'monthYear' ? (
          ...
          {((dateFilter === 'custom' && startDate && endDate && !showDateRange) || 
           (dateFilter === 'monthYear' && !showDateRange)) ? (
